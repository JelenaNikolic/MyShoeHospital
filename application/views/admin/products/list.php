                ...
                <div class="form-group">					
					<h4 style="margin-left: 30px;"><b>Lista svih modela cipela</b></h4><br/>
						...
						<div style="margin-left: 30px"><br/>
							...
							<div style="text-align: left; float: left; margin-left: 60px ">
								Sifra<br/>
								Naziv<br/>
								Opis<br/>
								Cena<br/><br/>
						...
						<div style="margin-left: 30px">
							<b>Model 2</b><a href="#" style="float: right; margin-right: 300px;">Edit</a><a href="#"style="float: right; margin-right: 30px;">Delete</a>
							<div style="clear: both"></div>
							<div style="text-align: left; float: left; margin-left: 60px ">
								Sifra<br/>
								Naziv<br/>
						...
						<div style="margin-left: 30px">
							<b>Model 3</b><a href="#" style="float: right; margin-right: 300px;">Edit</a><a href="#"style="float: right; margin-right: 30px;">Delete</a>
							<div style="clear: both"></div>
							<div style="text-align: left; float: left; margin-left: 60px ">
								Sifra<br/>
								Naziv<br/>
						...
						<hr>
						<h5 style="margin-left: 30px"><b>Zenske cipele</b></h5>
						<div style="margin-left: 30px"><br/>
							<b>Model 4</b><a href="#" style="float: right; margin-right: 300px;">Edit</a><a href="#"style="float: right; margin-right: 30px;">Delete</a>
							<div style="clear: both"></div>
							<div style="text-align: left; float: left; margin-left: 60px ">
								Sifra<br/>
								Naziv<br/>
						...
						<div style="margin-left: 30px">
							<b>Model 5</b><a href="#" style="float: right; margin-right: 300px;">Edit</a><a href="#"style="float: right; margin-right: 30px;">Delete</a>
							<div style="clear: both"></div>
							<div style="text-align: left; float: left; margin-left: 60px ">
								Sifra<br/>
								Naziv<br/>
						...
						<div style="margin-left: 30px">
							<b>Model 6</b><a href="#" style="float: right; margin-right: 300px;">Edit</a><a href="#"style="float: right; margin-right: 30px;">Delete</a>
							<div style="clear: both"></div>
							<div style="text-align: left; float: left; margin-left: 60px ">
								Sifra<br/>
								Naziv<br/>
						...
						<hr>
						<h5 style="margin-left: 30px"><b>Decije cipele</b></h5>
						<div style="margin-left: 30px"><br/>
							<b>Model 7</b><a href="#" style="float: right; margin-right: 300px;">Edit</a><a href="#"style="float: right; margin-right: 30px;">Delete</a>
							<div style="clear: both"></div>
							<div style="text-align: left; float: left; margin-left: 60px ">
								Sifra<br/>
								Naziv<br/>
						...
						<div style="margin-left: 30px">
							<b>Model 8</b><a href="#" style="float: right; margin-right: 300px;">Edit</a><a href="#"style="float: right; margin-right: 30px;">Delete</a>
							<div style="clear: both"></div>
							<div style="text-align: left; float: left; margin-left: 60px ">
								Sifra<br/>
								Naziv<br/>
						...
						<div style="margin-left: 30px">
							<b>Model 9</b><a href="#" style="float: right; margin-right: 300px;">Edit</a><a href="#"style="float: right; margin-right: 30px;">Delete</a>
							<div style="clear: both"></div>
							<div style="text-align: left; float: left; margin-left: 60px ">
								Sifra<br/>
								Naziv<br/>
